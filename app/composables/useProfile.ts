...
export function useProfile() {
  const name = 'Dario'
  const fullName = 'Dario'
  const email = 'dario@example.com'
  const location = 'Argentina'
  const avatar = '/avatar.jpg'

  const socialLinks: SocialLink[] = [
    { name: 'GitHub', url: 'https://github.com/dario', icon: 'i-simple-icons-github' },
    { name: 'LinkedIn', url: 'https://linkedin.com/in/dario', icon: 'i-simple-icons-linkedin' },
    { name: 'Twitter', url: 'https://twitter.com/dario', icon: 'i-simple-icons-x' },
    { name: 'Email', url: 'mailto:dario@example.com', icon: 'i-lucide-mail' }
  ]

  const techStack: Skill[] = [
    { name: 'Vue.js', icon: 'i-simple-icons-vuedotjs', category: 'frontend', level: 95 },
    { name: 'Nuxt', icon: 'i-simple-icons-nuxtdotjs', category: 'frontend', level: 90 },
    { name: 'TypeScript', icon: 'i-simple-icons-typescript', category: 'frontend', level: 90 },
    { name: 'Tailwind CSS', icon: 'i-simple-icons-tailwindcss', category: 'frontend', level: 95 },
    { name: 'React', icon: 'i-simple-icons-react', category: 'frontend', level: 80 },
    { name: 'Node.js', icon: 'i-simple-icons-nodedotjs', category: 'backend', level: 85 },
    { name: 'PostgreSQL', icon: 'i-simple-icons-postgresql', category: 'backend', level: 80 },
    { name: 'Docker', icon: 'i-simple-icons-docker', category: 'tools', level: 75 },
    { name: 'Git', icon: 'i-simple-icons-git', category: 'tools', level: 90 },
    { name: 'Figma', icon: 'i-simple-icons-figma', category: 'tools', level: 70 },
    { name: 'Python', icon: 'i-simple-icons-python', category: 'backend', level: 75 },
    { name: 'MongoDB', icon: 'i-simple-icons-mongodb', category: 'backend', level: 78 }
  ]
